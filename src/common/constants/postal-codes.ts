import { IPostalCode } from '@common/models/postal-code/postal-code.model';

export const POSTAL_CODES: IPostalCode[] = [
  {
    Note:
  ...
  {
    Note:
      'Postleitzahl (PLZ), introduced after the German reunification. Between 1989 and 1993 the old separate 4-digit postal codes of former West- and East-Germany were distinguished by preceding "W-" or "O-" (\'Ost\' for East).',
    Country: 'Germany',
    ISO: 'DE',
    Format: 'NNNNN',
    Regex: '^\\d{5}',
  ...
  {
    Note:
      "Postcode is always written BEFORE the city/place name, i.e. to the Right in Hebrew or Arabic script - to the Left in Latin script.  This also allows the legacy postal code version (even though deprecated) since it's still in high use.",
    Country: 'Israel',
    ISO: 'IL',
  ...
  {
    Note:
      'With Liechtenstein, ordered from west to east. In Geneva and other big cities, like Basel, Bern, Zurich, there may be one or two digits after the name of the city when the generic City code (1211) is used instead of the area-specific code (1201, 1202...), e.g.: 1211 Geneva 13. The digit identifies the post office. This addressing is generally used for P.O. box deliveries.',
    Country: 'Switzerland',
    ISO: 'CH',
    Format: 'NNNN',
    Regex: '^\\d{4}',
  ...
  {
    Note:
      'System for Sana\'a Governorate using geocoding "عنواني" based on the OpenPostcode algorithm is inaugurated in 2014.[9]',
    Country: 'Yemen',
    ISO: 'YE',
    Format: '- no codes -',
    Regex: '',
